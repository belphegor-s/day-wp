...
export default function Home() {
  return (
    <div className="mx-auto flex min-h-dvh max-w-[880px] flex-col px-4 sm:px-8">
      ...
      <main className="flex-1">
        <section className="pt-20 pb-24 sm:pt-28">
          ...
          <p className="mt-8 max-w-[34rem] text-[17px] leading-relaxed text-muted">
            A lock-screen wallpaper that redraws itself. Every day of the year is a dot — the ones behind you filled in, today filling by the hour. No app, just a URL your phone fetches.
          </p>
      ...
      <footer className="flex items-center justify-between border-t border-line py-8 font-mono text-[12px] text-muted">
        <span>Day Wallpaper</span>
